					...
					<ul>
						<li>
							<a href="#">
								...
								<div class="con_txt">
									...
									<p class="tit">우~우~ 풍문으로 들었소, 광주환경공단 업무가 아니라는 사실을!</p>
									<div class="bot">
						...
						<li>
							<a href="#">
								...
								<div class="con_txt">
									...
									<p class="tit">장애인 직업 재화지원과 지원순환을 위한 페토너 카트리지 기부</p>
									<div class="bot">
										<p class="vol">vol. 71</p>
										<ul class="tag">
											<li>#민원정보</li>
						...
						<li>
							<a href="#">
								<div class="img"><img src="/thema/basic/images/main/img_test3.jpg" alt="" /></div>
								<div class="con_txt">
									<p class="type type_1">함께G</p>
									<p class="tit">세상에 나쁜 쓰레기는 없다! 일상생활 속 올바른 쓰레기 처리법 & 재활용법</p>
									<div class="bot">
										<p class="vol">vol. 71</p>
										<ul class="tag">
											<li>#민원정보</li>
...
<div id="webzine_last_view">
	<div class="inner">
		<div class="con_txt">
			...
			<p class="btn_go"><a href="?contentId=abb7c68a0900d318989c201245657cf7433701a9ff1e317f7043ac8aaebebbb4">바로가기 <i class="fas fa-thin fa-arrow-right"></i></a></p>
		</div>
	</div>
</div>
<!-- //지난호보기 -->
