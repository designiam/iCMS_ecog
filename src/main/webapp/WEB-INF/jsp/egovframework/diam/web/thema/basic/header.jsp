...
<link rel="stylesheet" href="<c:url value='/fonts/GmarketSans/gmarketsans.css' />">
<link rel="stylesheet" href="<c:url value='/fonts/SCoreDream/scdream.css' />">
...
<script type="text/javascript" src="<c:url value='/js/egovframework/diam/jquery-ui-1.12.1/jquery-ui.js'/>"></script>
<script type="text/javascript" src="<c:url value='/js/egovframework/diam/jquery-ui-1.12.1/jquery-ui-datepicker.set.defaults.js'/>"></script>
