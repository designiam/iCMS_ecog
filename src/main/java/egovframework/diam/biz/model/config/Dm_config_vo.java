...
public class Dm_config_vo implements Serializable {
	...
	/** 도메인 기본설정 도메인주소 */
	@Pattern(regexp=pattern1 + "|" + pattern2, message="도메인주소 형식에 맞지 않습니다. 입력값을 확인해주세요.", groups=validGroupConfig.class)
	@Size(min=1, max=50, message="도메인주소는 1자 이상 50자 이하로 입력해주세요.", groups=validGroupConfig.class)
